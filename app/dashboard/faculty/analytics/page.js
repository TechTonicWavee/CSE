...
const navLinks = [
  ...
  { id: 'analytics',  label: 'Subject Analytics',icon: Activity,   badge: null,  active: true,  path: '/dashboard/faculty/analytics' },
...
const studentTableData = [
  { rank: 1, name: 'Siddharth Rao', roll: '2CS38', internal: '28/30', external: '66/70', total: '94/100', att: '92%', status: 'Strong', sColor: 'green' },
  { rank: 2, name: 'Ananya Verma', roll: '2CS07', internal: '27/30', external: '62/70', total: '89/100', att: '88%', status: 'Strong', sColor: 'green' },
  { rank: 3, name: 'Aryan Mehta', roll: '2CS41', internal: '26/30', external: '60/70', total: '86/100', att: '90%', status: 'Strong', sColor: 'green' },
  { rank: 4, name: 'Priya Sharma', roll: '2CS18', internal: '25/30', external: '58/70', total: '83/100', att: '85%', status: 'On Track', sColor: 'blue' },
  { rank: 5, name: 'Priyanshu Raj', roll: '2CS04', internal: '24/30', external: '47/70', total: '71/100', att: '86%', status: 'On Track', sColor: 'blue' },
  { rank: 6, name: 'Neha Joshi', roll: '2CS33', internal: '22/30', external: '44/70', total: '66/100', att: '80%', status: 'Watch', sColor: 'amber' },
  { rank: 7, name: 'Divya Patel', roll: '2CS14', internal: '20/30', external: '43/70', total: '63/100', att: '78%', status: 'Watch', sColor: 'amber' },
  { rank: 8, name: 'Karan Joshi', roll: '2CS15', internal: '18/30', external: '41/70', total: '59/100', att: '74%', status: 'At Risk', sColor: 'red', alert: true },
  { rank: 9, name: 'Rohit Sharma', roll: '2CS47', internal: '16/30', external: '38/70', total: '54/100', att: '71%', status: 'At Risk', sColor: 'red', alert: true },
  { rank: 10, name: 'Sneha Patel', roll: '2CS23', internal: '14/30', external: '33/70', total: '47/100', att: '68%', status: 'Critical', sColor: 'red', alert: true, darkRed: true }
]
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 bg-gray-50/50">
          <div className="max-w-7xl mx-auto space-y-8 animate-fade-in pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
              <div>
                <h1 className="text-2xl sm:text-[28px] font-bold text-navy mb-1 leading-tight">Subject Analytics</h1>
                <p className="text-gray-500 text-sm max-w-xl">Deep performance insights across all your subjects — identify gaps before they become failures</p>
              </div>
              <div className="relative min-w-[220px]">
                <select className="w-full appearance-none bg-white border border-gray-200 text-navy font-semibold text-sm rounded-xl px-4 py-2.5 pr-10 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent shadow-sm cursor-pointer">
                  <option>DBMS — CSE 2B</option>
                  <option>Operating Systems — CSE 2A</option>
                  <option>Theory of Computation — CSE 2C</option>
                  <option>Data Structures — CSE 1A</option>
                </select>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              <div className="bg-white border-l-4 border-l-blue-500 rounded-xl p-4 shadow-sm">
                ...
                <p className="text-3xl font-black text-blue-600 mb-1">62</p>
                <p className="text-xs text-gray-500">Enrolled in DBMS 2B</p>
              </div>
              <div className="bg-white border-l-4 border-l-amber-500 rounded-xl p-4 shadow-sm">
                <p className="text-xs font-semibold text-gray-500 uppercase mb-1">Class Average</p>
                <p className="text-3xl font-black text-amber-600 mb-1">64%</p>
                <p className="text-[10px] font-bold text-red-500 uppercase tracking-wide">Below 70% target</p>
                <p className="text-xs text-gray-500 mt-0.5">Unit 3 exam</p>
              </div>
              <div className="bg-white border-l-4 border-l-amber-500 rounded-xl p-4 shadow-sm">
                <p className="text-xs font-semibold text-gray-500 uppercase mb-1">CO Attainment</p>
                <p className="text-3xl font-black text-amber-600 mb-1">71%</p>
                <p className="text-[10px] font-bold text-amber-600 uppercase tracking-wide">4% gap remaining</p>
              ...
              <div className="bg-white border-l-4 border-l-red-500 rounded-xl p-4 shadow-sm relative overflow-hidden">
                <AlertTriangle size={48} className="absolute -right-2 -bottom-2 text-red-50/50 pointer-events-none" />
                <p className="text-xs font-semibold text-gray-500 uppercase mb-1 flex items-center gap-1"><AlertTriangle size={12} className="text-red-500" /> At-Risk Students</p>
                <p className="text-3xl font-black text-red-600 mb-1">8</p>
                <p className="text-xs text-red-500 font-medium">Score below 50%</p>
              </div>
              <div className="bg-white border-l-4 border-l-green-500 rounded-xl p-4 shadow-sm col-span-2 md:col-span-1">
                <p className="text-xs font-semibold text-gray-500 uppercase mb-1 flex items-center gap-1"><Star size={12} className="text-green-500" /> Top Scorer</p>
                <p className="text-lg font-bold text-green-700 leading-tight mb-2">Siddharth Rao</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col">
                ...
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={scoreDistData} margin={{ top: 5, right: 20, left: -20, bottom: 5 }}>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 text-center">
                  <p className="text-sm font-semibold text-navy">Class average: 64% — <span className="text-red-500 font-bold">19 students below 60%</span></p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col relative">
                ...
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={unitTrendData} margin={{ top: 20, right: 30, left: -20, bottom: 5 }}>
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f3f4f6" />
                        ...
                        if (payload.unit === 'Unit 3') {
                          return (
                            <g key="u3-dot">
                              ...
                              <text x={cx} y={cy - 15} textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">{payload.score}%</text>
                            </g>
                          )
                        }
                        return (
                          <g key={`${cx}-${cy}`}>
                            ...
                            <text x={cx} y={cy - 12} textAnchor="middle" fill="#3B82F6" fontSize="10" fontWeight="bold">{payload.score}%</text>
                          </g>
                        );
                      }} />
                    </LineChart>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h3 className="text-lg font-bold text-navy mb-1">Topic-Wise Performance Heatmap</h3>
                <p className="text-sm text-gray-500">Average score per topic across the class — red means the class struggled, green means they understood it well</p>
              </div>
                      ...
                      <tr key={i} className="hover:bg-gray-50/50">
                        <td className="px-6 py-4 text-navy">
                          <div className="flex items-center gap-2">
                            {row.topic}
                            {row.badge && (
                              <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${row.badge === 'Critical' ? 'bg-red-100 text-red-700' : 'bg-amber-100 text-amber-700'}`}>
                                {row.badge}
                              </span>
                            )}
                          </div>
                        ...
                        <td className="px-1 py-1">
                          <div className={`w-full h-full p-3 rounded-lg text-center ${getColorForScore(row.a)}`}>{row.a}%</div>
                        </td>
                        <td className="px-1 py-1">
                          <div className={`w-full h-full p-3 rounded-lg text-center ${getColorForScore(row.q)}`}>{row.q}%</div>
                        </td>
                        <td className="px-1 py-1">
                          <div className={`w-full h-full p-3 rounded-lg text-center ${getColorForScore(row.u)}`}>{row.u}%</div>
                        </td>
                        <td className="px-1 py-1">
                          <div className={`w-full h-full p-3 rounded-lg text-center ${getColorForScore(row.p)}`}>{row.p}%</div>
                        </td>
                        <td className="px-6 py-4 text-right">
                          <span className={`inline-block px-3 py-1 rounded font-bold text-${row.pill}-700 bg-${row.pill}-50 border border-${row.pill}-100`}>
                            {row.avg}%
                          </span>
                        </td>
                      </tr>
              ...
              <div className="p-6 bg-gray-50 border-t border-gray-100">
                <div className="bg-red-50 border border-red-200 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
                  <div className="flex gap-4 items-start max-w-3xl">
                    ...
                    <div>
                      <h4 className="font-bold text-red-900 mb-1">Normalization and Transactions are critical weak areas</h4>
                      <p className="text-sm text-red-800 leading-relaxed font-medium">
                        2 topics where more than 40% of students scored below 50% in unit exams. Consider a re-teaching session before the next unit begins.
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h3 className="text-lg font-bold text-navy mb-1">Course Outcome Attainment — DBMS</h3>
                <p className="text-sm text-gray-500">NBA requires 75% attainment on all Course Outcomes</p>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-100 text-sm font-medium">
                    {coData.map((row, i) => (
                      <tr key={i} className="hover:bg-gray-50/50">
                        <td className="px-6 py-4 text-navy font-bold">{row.id}</td>
                        <td className="px-6 py-4 text-gray-700">{row.desc}</td>
                        <td className="px-6 py-4 text-gray-500">{row.target}%</td>
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <span className="font-bold text-navy">{row.attained}%</span>
                            {row.bar && (
                              <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden w-16">
                                <div className="h-full bg-red-500 rounded-full" style={{ width: `${row.attained}%` }} />
                              </div>
                            )}
                          </div>
                        </td>
                        <td className={`px-6 py-4 font-bold ${row.gap.startsWith('+') ? 'text-green-600' : 'text-red-500'}`}>
                          {row.gap}%
                        </td>
                        <td className="px-6 py-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <h3 className="text-lg font-bold text-navy">Student Performance — DBMS 2B</h3>
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                  <div className="relative w-full sm:w-64">
                    <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                    <input type="text" placeholder="Search by name or roll no..." className="w-full pl-9 pr-4 py-2 text-sm rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                  </div>
                ...
                <table className="w-full text-left border-collapse whitespace-nowrap">
                  <thead>
                    <tr className="bg-gray-50 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-200">
                      ...
                      <th className="px-4 py-4 text-center font-black">Total</th>
                  ...
                  <tbody className="divide-y divide-gray-100 text-sm font-medium">
                    {studentTableData.map((row, i) => (
                      <tr key={i} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-4 py-4 text-center text-gray-600">{row.internal}</td>
                        <td className="px-4 py-4 text-center text-gray-600">{row.external}</td>
                        <td className="px-4 py-4 text-center font-bold text-navy">{row.total}</td>
                        <td className="px-4 py-4 text-center text-gray-600">{row.att}</td>
                        <td className="px-4 py-4">
                          <span className={`inline-block px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${row.darkRed ? 'bg-red-600 text-white' : `bg-${row.sColor}-100 text-${row.sColor}-700`}`}>
                            {row.status}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-right flex items-center justify-end gap-2">
                          {row.alert && (
                            <button className="p-1.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition" title="Create Alert">
              ...
              <div className="p-4 border-t border-gray-100 flex items-center justify-between text-sm text-gray-500">
                ...
                <div className="flex items-center gap-2">
                  <button className="p-1 rounded hover:bg-gray-100 disabled:opacity-50" disabled><ChevronLeft size={16} /></button>
                  <button className="w-8 h-8 rounded bg-teal-50 text-teal-700 font-bold">1</button>
                  <button className="w-8 h-8 rounded hover:bg-gray-100 font-medium text-gray-600">2</button>
                  <button className="w-8 h-8 rounded hover:bg-gray-100 font-medium text-gray-600">3</button>
                  <span>...</span>
                  <button className="w-8 h-8 rounded hover:bg-gray-100 font-medium text-gray-600">7</button>
