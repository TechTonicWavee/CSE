...
const facultySummary = [
  {
    ...
    catColor: "bg-green-100 text-green-800 border border-green-200",
  },
  {
    ...
    catColor: "bg-teal-100 text-teal-800 border border-teal-200",
  },
  {
    name: "Dr. Suresh Iyer",
    branch: "CSE",
...

  {
    ...
    co: "69%",
    category: "Average",
    catColor: "bg-amber-100 text-amber-800 border border-amber-200",
  },
  {
    name: "Dr. Ravi Sharma",
    branch: "CSE",
    ...
    co: "57%",
    category: "Critical",
    catColor: "bg-red-100 text-red-800 border border-red-200",
  },
];

const curriculumAlerts = [
  {
    subject: "Normalization (DBMS)",
    failRate: "41%",
    branches: "CSE",
    severity: "CRITICAL",
  },
  {
    subject: "Process Scheduling (OS)",
    failRate: "43%",
    branches: "CSE",
    severity: "CRITICAL",
  },
...
const insights = [
  {
    type: "positive",
    text: "CSE branch maintains highest health score (76/100) — 5 pts above department average.",
  },
  {
    type: "warning",
    text: "CSE at-risk ratio is 7.9% — intervention program has reduced it by 2.1% from last semester.",
  },
  {
    type: "positive",
    text: "Overall dept pass rate improved by 3.8% from S1 2024 to S1 2026.",
  },
  {
    type: "warning",
    text: "12 faculty members scoring below 60 — mentorship program advised.",
  },
  {
    type: "positive",
    text: "Placement readiness up 4% after industry connect workshop (Feb 2026).",
  },
  {
    type: "critical",
    text: "OS & DBMS failure rates exceed 40% across all batches — urgent curriculum review needed.",
  },
];
    ...
    <main className="px-8 py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
            {kpiData.map((k, i) => (
              <div
                key={i}
                className={`card animate-fade-in ${k.border}`}
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
            {/* Branch Table */}
            <div
              className="xl:col-span-2 card animate-fade-in"
                  ...
                  <tbody>
                    {filteredBranch.map((b, i) => (
                      ...
                      >
                        ...
                        <td className="py-3">
                          <span
                            className={`px-2.5 py-1 rounded-full text-xs font-bold ${b.statusColor}`}
                          >
                            {b.status}
                          </span>
                        </td>
                ...
                <tbody>
                  {filteredFaculty.map((f, i) => (
                    ...
                    >
                      ...
                      <td className="py-2.5">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-semibold ${f.catColor}`}
                        >
                          {f.category}
                        </span>
                      </td>
                ...
                {curriculumAlerts.map((c, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-bold border ${sevColor}`}
                      >
                        {c.severity}
                      </span>
                    </div>
              ...
              <div className="space-y-3">
                {insights.map((ins, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`flex gap-3 p-3 rounded-xl border ${style}`}
                    >
                      <div
